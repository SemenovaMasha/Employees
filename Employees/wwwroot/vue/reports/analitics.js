Vue.component('analitics',
{
    ...
    <div>
        ...
        <div class="form-group row " v-if="(project && (project.managerId==currentUser.id)) ">
                <label for="user" class="col-sm-4 col-form-label required">Сотрудник</label>         
                <v-select placeholder=" " v-model="user" as="fio::id" :from="allUsers" tagging class="col-sm-8"></v-select>              
        </div>  
    </div>
    `,
    data: function () {
